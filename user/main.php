    ...
    <div style="width: 1217px; height: auto; background: #FFFFFF; border: 1px solid black; border-radius: 4px;margin-left: 19%;">
        <form method="post">
            ...
            if (isset($_SESSION['member_name'])) {
                ...
                $stmt = $conn->prepare("SELECT * FROM report WHERE re_studentname = :member_name");
                $stmt->bindParam(':member_name', $_SESSION['member_name'], PDO::PARAM_STR);
                $stmt->execute();
                ...
                if ($filteredReports) {
                    ...
                    echo "<th width='7%'>Student ID</th>";
                    echo "<th width='10%'>Student name</th>";
                    echo "<th width='10%'>Serialnumber</th>";
                    echo "<th width='10%'>Borrow date</th>";
                    echo "<th width='10%'>Return date</th>";
                    ...
                    foreach ($filteredReports as $report) {
                        ...
                        echo "<td>{$report['re_studentid']}</td>";
                        echo "<td>{$report['re_studentname']}</td>";
