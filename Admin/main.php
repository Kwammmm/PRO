	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				// Prepare and execute the SQL query to count the records with re_status = 'กำลังยืม'
				$stmt = $conn->prepare("SELECT COUNT(*) as borrowing_count FROM report WHERE re_status = 'ยืม'");
				$stmt->execute();
				$result = $stmt->fetch(PDO::FETCH_ASSOC);
				$borrowing_count = $result['borrowing_count']
				?>
				...
				<div class="col-6 col-sm-3">
					<div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
						...
						<div class="card-body">
							<h5 class="card-title">จำนวน <?php echo number_format($borrowing_count); ?> คน</h5>
							<p class="card-text">
				...
				// Prepare and execute the SQL query to count the records with re_status = 'เกินกำหนด'
				$stmt = $conn->prepare("SELECT COUNT(*) as overdue_count FROM report WHERE re_status = 'เกินกำหนด'");
				$stmt->execute();
				$result = $stmt->fetch(PDO::FETCH_ASSOC);
				...
				<div class="col-6 col-sm-3">
					<div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
						<div class="card-header">
							<ion-icon name="cart-outline"></ion-icon> รายการค้างคืน
						</div>
						<div class="card-body">
							<h5 class="card-title">จำนวน <?php echo number_format($overdue_count); ?> ออเดอร์</h5>
							<p class="card-text">
    		...
    		FROM item");
				...
				<div class="col-6 col-sm-3">
					<div class="card text-white bg-info mb-3" style="max-width: 18rem;">
						...
						<div class="card-body">
							<h5 class="card-title">จำนวน <?php echo number_format($total_items); ?> รายการ</h5>
							<p class="card-text">
    ...
    FROM tbl_member");
				...
				<div class="col-6 col-sm-3">
					<div class="card text-white bg-success mb-3" style="max-width: 18rem;">
						...
						<div class="card-body">
							<h5 class="card-title">จำนวน<?php echo number_format($total_members); ?>คน</h5>
							<p class="card-text">
