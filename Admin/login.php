...
<html lang="en">
      ...
      <div class="row">
        ...
        <div class="col-md-8"> <br> 
          <h4>ADMIN LOGIN</h4>
              ...
              <div class="text" style="margin-left:17%; color:white;">
                    <a>You're not an admin, right?</a>
 ...
 if(isset($_POST['username']) && isset($_POST['password'])){
  ...
  $stmt = $conn->prepare("SELECT member_id,member_classS, member_name, member_sername,member_status FROM tbl_member WHERE username = :username AND password = :password");
